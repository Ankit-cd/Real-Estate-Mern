        ...
        <div className='p-7 border-b-2 md:border-r-2 md:min-h-screen'>
            <form onSubmit={sumbitHandler} className='flex flex-col gap-8'>
                <div className="flex items-center gap-2">
                    ...
                    <input onChange={handleChange} value={sidebarData.searchTerm} type="text" id='searchTerm' placeholder='Search...'
                ...
                <button type='submit' className='bg-slate-700 text-white p-3 rounded-lg uppercase hover:opcaity-95'>Search</button>
            </form>
        </div>
